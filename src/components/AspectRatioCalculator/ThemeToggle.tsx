...
export const ThemeToggle = () => {
  ...
  useEffect(() => {
    // Update localStorage and HTML data-theme attribute when theme changes
  ...
  return (
    <label className="swap swap-rotate">
      ...
      >
        <title id="sunIconTitle">Light mode (sun icon)</title>
      ...
      >
        <title id="moonIconTitle">Dark mode (moon icon)</title>
