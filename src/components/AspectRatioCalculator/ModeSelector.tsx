...
export const ModeSelector = ({ mode, onModeChange }: ModeSelectorProps) => {
  ...
  return (
    <div className="w-full px-6 py-4 bg-transparent backdrop-blur-sm border-b border-base-300/30 transition-all duration-300">
      <div
        role="tablist"
        className="tabs-container tabs tabs-boxed flex justify-center p-2 rounded-xl"
      >
        <button
          type="button"
          role="tab"
        ...
        >
          <span className="flex items-center">
            ...
            >
              ...
              <path
                fillRule="evenodd"
                d="M3 4a1 1 0 011-1h4a1 1 0 010 2H6.414l7.293 7.293a1 1 0 01-1.414 1.414L5 6.414V8a1 1 0 01-2 0V4z"
                clipRule="evenodd"
              />
            </svg>
            Get Height
        ...
        >
          <span className="flex items-center">
            ...
            >
              ...
              <path
                fillRule="evenodd"
                d="M17 4a1 1 0 00-1-1h-4a1 1 0 000 2h1.586l-7.293 7.293a1 1 0 001.414 1.414L15 6.414V8a1 1 0 002 0V4z"
                clipRule="evenodd"
              />
            </svg>
            Get Width
        ...
        <button
          ...
          className={`tab transition-all duration-300 font-medium ${
            mode === 'image-to-ratio'
              ? 'tab-active bg-info text-info-content'
              : hoveredTab === 'image-to-ratio'
                ? 'bg-info/10'
                : 'bg-white/70 dark:bg-base-200/70'
          }`}
        ...
        >
          <span className="flex items-center">
            <svg
              ...
              aria-hidden="true"
            >
              <title>Image to Ratio Icon</title>
              <path
                fillRule="evenodd"
                d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z"
                clipRule="evenodd"
