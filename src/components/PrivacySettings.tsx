...
export const PrivacySettings = () => {
  ...
  const savePreferences = () => {
    ...
    trackEvent(`${EVENTS.PRIVACY_SETTINGS_CHANGED}_analytics_${analyticsEnabled}`);
    trackEvent(`${EVENTS.PRIVACY_SETTINGS_CHANGED}_recording_${recordingEnabled}`);
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
      <div className="bg-base-100 rounded-lg shadow-lg p-6 max-w-md w-full">
        <h2 className="text-xl font-bold text-primary mb-4">Privacy Settings</h2>
        ...
        <div className="space-y-4">
          <div className="form-control">
            ...
            <p className="text-xs text-base-content/70 mt-1">
              Collects anonymous data about how you use the calculator to help us improve it.
            </p>
          </div>
          ...
          <div className="form-control">
            ...
            <p className="text-xs text-base-content/70 mt-1">
              Records your interactions with the calculator to help us understand how you use it.
