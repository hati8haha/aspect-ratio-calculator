...
export const PrivacyBanner = () => {
  ...
  const acceptPrivacy = () => {
    ...
    localStorage.setItem(ANALYTICS_ENABLED_KEY, ENABLE_ANALYTICS_BY_DEFAULT.toString());
    localStorage.setItem(RECORDING_ENABLED_KEY, ENABLE_RECORDING_BY_DEFAULT.toString());
    setIsVisible(false);
  };
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-primary text-white p-4 shadow-lg z-50 animate-slideUp">
      <div className="container mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="text-sm md:text-base">
          <p>
            This website uses cookies and visitor recording technologies to improve your experience and help us understand how visitors use our application.
